...
public class ViewRam extends javax.swing.JFrame {
    ...
    public ViewRam() {
        ...
        showDataTable(listRam);
    }
    
    private void showDataTable(List<Ram> list) {
        dtm.setRowCount(0);
        for (Ram ram : list) {
            dtm.addRow(new Object[]{ram.getMaRam(), ram.getDungLuong()});
        }
    }
    
    private void fillData(int index) {
        Ram ram = listRam.get(index);
        txtMa.setText(ram.getMaRam());
        txtTen.setText(ram.getDungLuong());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String ma = "MRAM"+rd.nextInt(999);
        String ten = txtTen.getText();
        Ram ram = new Ram(ma, ten);
        JOptionPane.showMessageDialog(this, ramService.add(ram));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String ten = txtTen.getText();
        Ram ram = new Ram(ma, ten);
        JOptionPane.showMessageDialog(this, ramService.update(ram, ma));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, ramService.delete(ma));
