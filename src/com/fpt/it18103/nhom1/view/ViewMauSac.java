...
public class ViewMauSac extends javax.swing.JFrame {
    ...
    public ViewMauSac() {
        ...
        showDataTable(listMauSac);
    }

    private void showDataTable(List<MauSac> list){
        dtm.setRowCount(0);
        for(MauSac ms : list){
            dtm.addRow(new Object[]{ms.getMaMS(), ms.getTenMS()});
        }
    }
    
    private void fillData(int index){
        MauSac ms = listMauSac.get(index);
        txtMauSac.setText(ms.getMaMS());
        txtTenMau.setText(ms.getTenMS());
    }
    /**
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtTenMau, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String ten  = txtTenMau.getText();
        MauSac ms = new MauSac(ma, ten);
        JOptionPane.showMessageDialog(this, mauSacService.update(ms,ma));
        listMauSac = mauSacService.getall();
        showDataTable(listMauSac);
